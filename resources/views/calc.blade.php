    ...
    <div class="container-sm mt-5">
        ...
        <div class="container">
            <div class="selection">
                <div class="row justify-content-md-center">
                    <div class="col">
                        <img src="/img/mini_1.jpg" class="icon" onclick="type=1; upload()"
                             title="Расчет одностворчатого окна" alt="Расчет одностворчатого окна">
                    </div>
                    <div class="col">
                        <img src="/img/mini_6.jpg" class="icon" onclick="type=6; upload()"
                             title="Расчет Т-образного окна" alt="Расчет Т-образного окна">
                    </div>
                    <div class="col">
                        <img src="/img/mini_2.jpg" class="icon" onclick="type=2; upload()"
                             title="Расчет двухстворчатого окна" alt="Расчет двухстворчатого окна">
                    </div>
                    <div class="col">
                        <img src="/img/mini_7.jpg" class="icon" onclick="type=7; upload()"
                             title="Расчет Т-образного двухстворчатого окна"
                             alt="Расчет Т-образного двухстворчатого окна">
                    </div>
                    <div class="col">
                        <img src="/img/mini_3.jpg" class="icon" onclick="type=3; upload()"
                             title="Расчет трехстворчатого окна" alt="Расчет трехстворчатого окна"/>
                    </div>
                    <div class="col">
                        <img src="/img/mini_8.jpg" class="icon" onclick="type=8; upload()"
                             title="Расчет Т-образного 3-х створчатого окна"
                             alt="Расчет Т-образного 3-х створчатого окна">
                    </div>
                    <div class="col">
                        <img src="/img/mini_4.jpg" class="icon" onclick="type=4; upload()"
                             title="Расчет балконного блока" alt="Расчет балконного блока">
                    </div>
                    <div class="col">
                        <img src="/img/mini_5.jpg" class="icon" onclick="type=5; upload()"
                             title="Расчет двухстворчатого балконного блока"
                             alt="Расчет двухстворчатого балконного блока">
                    </div>
                    <div class="col">
                        <img src="/img/mini_10.jpg" class="icon" onclick="type=10; upload()"
                             title="Расчет балконной двери" alt="Расчет балконной двери">
                    </div>
                    <div class="col">
                        <img src="/img/mini_12.jpg" class="icon" onclick="type=12; upload()"
                             title="Расчет балконной двери с фрамугой" alt="Расчет балконной двери с фрамугой">
                    </div>
                </div>
            </div>
        </div>
        ...
        <fieldset>
            ...
            <div align="center" style="height:456px;">
                <div class="box-warning">ВНИМАНИЕ ! Обязательно выберите поворотные и/или поворотно-откидные створки,
                    иначе окно будет глухим (без открывающихся створок).
                </div>
                <table cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                    <tr>
                        <td class="td_input"
                            style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_h" id="fr_div_h_l" style="display: none; line-height:10px;">Высота<br/>фрамуги<br>
                                <input class="wh" type="text" id="fr_height2" name="textfield" maxlength="3" value="600"
                                       onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div id="fr_div_1" style="display: none;padding:0; margin:0; height:71px; cursor:pointer;">
                                <img src="/img/fram_1.jpg" id="f1" onclick="smena_img(4,4)" alt="Глухая фрамуга"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div id="fr_div_2" style="display: none;padding:0; margin:0; height:71px; cursor:pointer;">
                                <img src="/img/fram_2.jpg" id="f2" onclick="smena_img(5,5)" alt="Стоимость окна"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div id="fr_div_3" style="display: none;padding:0; margin:0; height:71px; cursor:pointer;">
                                <img src="/img/fram_3.jpg" id="f3" onclick="smena_img(6,6)" title=""
                                     alt="Расчет фрамуги"></div>
                        </td>
                        <td class="td_input"
                            style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_h" id="fr_div_h" style="display: none; line-height:10px">Высота<br/>фрамуги<br>
                                <input class="wh" type="text" id="fr_height" name="textfield" maxlength="3" value="600"
                                       onkeyup="test_razm()"></div>
                        </td>
                    </tr>
                    </tbody>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td class="td_input"
                            ...
                            <div class="input_h" id="dr_div_h" style="display: none; line-height:10px"><br>Высота<br/>двери<br>
                                <input class="wh" type="text" id="dr_height" name="textfield" value="2100"
                                       onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;vertical-align: top;">
                            <div id="win_div_1" style="display: block; cursor:pointer;"><img src="/img/stv_gl.jpg"
                                                                                             id="w1"
                                                                                             onclick="smena_img(0,0)"
                                                                                             alt="Пластиковое окно">
                            </div>
                        </td>
                        <td rowspan="2"
                            style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div id="dr_div_1" style="display: none; cursor:pointer;"><img src="/img/dr_pv.jpg" id="dr"
                                                                                           onclick="smena_img(3,3)"
                                                                                           alt="Пластиковая балконная дверь">
                            </div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;vertical-align: top;">
                            <div id="win_div_2" style="display: block; cursor:pointer;"><img src="/img/stv_gl.jpg"
                                                                                             id="w2"
                                                                                             onclick="smena_img(1,1)"
                                                                                             alt="Пластиковое окно">
                            </div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;vertical-align: top;">
                            <div id="win_div_3" style="display: block; cursor:pointer;"><img src="/img/stv_gl.jpg"
                                                                                             id="w3"
                                                                                             onclick="smena_img(2,2)"
                                                                                             title=""
                                                                                             alt="Расчет пластикового окна">
                            </div>
                        </td>
                        <td class="td_input">
                            <div class="input_h" id="win_div_h" style="display: block; line-height:10px">Высота<br/>окна<br>
                                <input class="wh" type="text" id="win_height" name="textfield" maxlength="4"
                                       value="1500" onkeyup="test_razm()"></div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;"></td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_bb_w" id="win_1_div_w" style="display: block;">Ширина<br>
                                <input class="wh" type="text" id="win_1_width" name="textfield" maxlength="4"
                                       value="700" onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_bb_w" id="win_2_div_w" style="display: block;">Ширина<br>
                                <input class="wh" type="text" id="win_2_width" name="textfield" maxlength="4"
                                       value="700" onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_bb_w" id="win_3_div_w" style="display: block;">Ширина<br>
                                <input class="wh" type="text" id="win_3_width" name="textfield" maxlength="4"
                                       value="700" onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;"></td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_w" id="dr_div_w" style="display: none;">Ширина<br>
                                <input class="wh" type="text" id="dr_width" name="textfield" maxlength="4" value="750"
                                       onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;"></td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;"></td>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div id="gl_div_1" style="display: none; cursor:pointer;"><img src="/img/fram_1.jpg" id="n1"
                                                                                           onclick="smena_img(7,7)"
                                                                                           alt="Глухая фрамуга"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div id="gl_div_2" style="display: none; cursor:pointer;"><img src="/img/fram_1.jpg" id="n2"
                                                                                           onclick="smena_img(8,8)"
                                                                                           alt="Фрамужное окно"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div id="gl_div_3" style="display: none; cursor:pointer;"><img src="/img/fram_1.jpg" id="n3" onclick="smena_img(9,9)" alt="Низ окна"></div>
                        </td>
                        <td class="td_input"
                            style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_h" id="gl_div_h" style="display: none; line-height:10px">
                                Высота<br/>низа<br>
                                <input class="wh" type="text" id="gl_height" name="textfield" maxlength="3" value="500"
                                       onkeyup="test_razm()"></div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_w" id="gl_1_div_w" style="display: none;">Ширина<br>
                                <input class="wh" type="text" id="gl_1_width" name="textfield" maxlength="4" value="900"
                                       onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_w" id="gl_2_div_w" style="display: none;">Ширина<br>
                                <input class="wh" type="text" id="gl_2_width" name="textfield" maxlength="4" value="900"
                                       onkeyup="test_razm()"></div>
                        </td>
                        <td style="padding:0; margin:0;letter-spacing: 0em;*letter-spacing: normal;word-spacing: 0em;">
                            <div class="input_w" id="gl_3_div_w" style="display: none;">Ширина<br>
                                <input class="wh" type="text" id="gl_3_width" name="textfield" maxlength="4" value="900"
                                       onkeyup="test_razm()"></div>
                        </td>
                        <td></td>
                    </tr>
        ...
        <div class="container">
            <div class="selectors d-flex align-items-start flex-column align-items-center">
                <legend>Нажимайте на селекторы, чтобы выбрать опции</legend>
                <select class="form-select" hidden="" id="prof_color" style="width: 257px;">
                ...
                <label for="steklopaket">Стеклопакет:
                    <select class="form-select" id="steklopaket" style="width: 257px;">
                ...
                <select class="form-select" hidden="" id="steklo_tip" style="width: 257px;">
                ...
                <label for="podokonnik">Подоконник:
                    <select class="form-select" id="podokonnik" style="width: 257px;">
                ...
                <label for="montazh">Монтаж:
                    <select class="form-select" id="montazh" style="width: 257px;">
                        <option value="0" selected="selected">Нет</option>
                ...
                <label for="otkosi">Откосы:
                    <select class="form-select" id="otkosi" style="width: 257px;">
                        <option value="0" selected="selected">Нет</option>
                ...
                <label for="dostavka">Доставка:
                    <select class="form-select" id="dostavka" style="width: 257px;">
                        <option value="0" selected="selected">Нет</option>
